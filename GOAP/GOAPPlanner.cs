...
public class GOAPPlanner
{
    ...
    public List<GOAPAction> Plan(NPCState npcState, WorldState worldState)
    {
        ...
        int maxIterations = 10000; // 최대 탐색 횟수 설정
        int iterations = 0;
        ...
        while (!openList.IsEmpty())
        {
            ...
            {
                Debug.LogError("GOAP Planner exceeded maximum iterations. Possible infinite loop.");
                return null;
            }
        ...
        Debug.LogError("GOAP Planner could not find a plan to achieve the goals.");
        return null;
    }
